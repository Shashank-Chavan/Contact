...
public class Contact_Page extends Fragment implements Adapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ft.replace(R.id.Container, new AddContacts()).commit();
            }
        });
        ...
        viewModel.getLiveData().observe(requireActivity(), new Observer<List<Data>>() {
            ...
            public void onChanged(List<Data> dataList) {
                adapter = new Adapter(dataList,Contact_Page.this::onItemClick);
    ...
    public void onItemClick(Data data) {
        Fragment fragment = ContactDetails.newInstance(data.getName(), data.getNumber(), data.getEmail());
